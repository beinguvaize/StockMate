...
const ReportPerformance = ({ sales, products, businessProfile}) => {
 ...
 <div className="glass-panel !p-5 rounded-[2.5rem] border border-border/60 bg-canvas/30">
 ...
 <span className="w-6 text-[10px] font-semibold text-foreground opacity-20 group-hover:opacity-100 transition-opacity">0{idx+1}</span>
