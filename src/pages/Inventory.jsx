...
const Inventory = () => {
 ...
 <label className="block text-[9px] font-semibold text-gray-700 opacity-[0.85] mb-0.5 ml-1">Category</label>
 <select className="w-full bg-canvas border-none rounded-lg p-2.5 font-semibold text-xs text-ink-primary outline-none focus:ring-2 focus:ring-accent-signature/20 transition-all appearance-none" value={formData.category} onChange={e => setFormData({ ...formData, category: e.target.value})}>
