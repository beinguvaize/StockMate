      ...
      <div className="relative w-full max-w-md bg-surface rounded-[2rem] shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-200">
        ...
        <div className="p-6 space-y-5">
          ...
          <button
            ...
            disabled={rpmLoading}
            className="w-full flex items-center gap-4 p-4 rounded-2xl bg-gradient-to-r from-violet-600 to-indigo-600 text-white hover:opacity-90 active:scale-[0.98] transition-all shadow-lg disabled:opacity-70"
          >
