...
export function ProtectedRoute({ children }) {
  ...
  if (moduleKey && !hasPermission(moduleKey, 'view')) {
      return (
          <div className="flex flex-col items-center justify-center min-h-[80vh] p-8 animate-in fade-in zoom-in duration-500">
              <div className="glass-panel max-w-[500px] w-full text-center p-12 border-red-500/10">
                  <div className="flex justify-center mb-8 relative">
                      <div className="bg-red-500/5 p-10 rounded-full text-red-500">
                  ...
                  <h2 className="text-4xl font-black tracking-tighter text-[#111] uppercase mb-4 leading-none">Security Restricted</h2>
                  <p className="text-[10px] font-black text-[#747576] tracking-[0.3em] uppercase opacity-70 mb-10 leading-relaxed max-w-[300px] mx-auto">
