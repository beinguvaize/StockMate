        ...
        <div className="modal-overlay">
          <div className="bg-white rounded-3xl shadow-2xl max-w-5xl w-full max-h-[92vh] overflow-hidden flex flex-col">
            ...
            <div className="flex items-center justify-between px-8 py-5 border-b border-black/5">
              ...
              <button onClick={() => setShowCreator(false)} className="w-9 h-9 rounded-xl bg-white border border-gray-300 shadow-sm flex items-center justify-center text-gray-400 hover:bg-rose-50 hover:text-rose-500 transition-all">
                <X size={16} />
              </button>
            </div>
              ...
              <div className="flex-1 overflow-y-auto px-8 py-6 space-y-6">
                ...
                <div className="grid grid-cols-3 gap-4">
                  <div className="col-span-1 space-y-1.5">
                    ...
                    <select
                      className="w-full bg-white border border-gray-300 shadow-sm rounded-xl px-3 py-2.5 text-sm font-semibold text-ink-primary outline-none focus:ring-2 focus:ring-ink-primary/10 transition"
                ...
                <div className="space-y-1.5">
                  ...
                  <textarea
                    ...
                    className="w-full bg-white border border-gray-300 shadow-sm rounded-xl px-3 py-2.5 text-xs font-medium text-ink-primary outline-none focus:ring-2 focus:ring-ink-primary/10 transition resize-none"
                    value={draft.notes}
