      ...
      <div className="px-6 py-3 border-b border-black/5 bg-white shrink-0 flex items-center gap-3">
        <div className="relative flex-1 max-w-xs">
          ...
          <input
            ...
            className="w-full pl-8 pr-4 py-2 text-xs font-semibold bg-white border border-gray-200 shadow-sm rounded-xl outline-none focus:ring-2 focus:ring-accent-signature/25"
          />
        </div>
