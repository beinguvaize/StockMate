              ...
              <section>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <input type="text" defaultValue={selectedTenant.name} ref={nameRef} autoComplete="off" className="w-full px-4 py-3 bg-canvas border border-black/5 rounded-xl text-xs font-bold focus:ring-2 focus:ring-accent-signature/20 focus:border-accent-signature outline-none transition-all" />
                  </div>
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input type="text" defaultValue={selectedTenant.slug} ref={slugRef} autoComplete="off" className="w-full pl-7 pr-4 py-3 bg-canvas border border-black/5 rounded-xl text-xs font-mono font-bold focus:ring-2 focus:ring-accent-signature/20 focus:border-accent-signature outline-none transition-all uppercase" />
                    </div>
                  </div>
                </div>
              </section>
