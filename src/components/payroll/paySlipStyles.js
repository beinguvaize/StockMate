...
const SHEET = `
  ...
  /* Month and year side by side, split by a hairline. Two stacked blocks would
     not fit the 74mm sheet once the instalment list is also present. */
  .ps-totals{margin-top:auto;background:#f5f6f8;padding:1.3mm 1.8mm;display:grid;
             grid-template-columns:1fr 1fr;gap:2mm;}
  .ps-tot + .ps-tot{border-left:1px solid #dcdfe4;padding-left:2mm;}
  .ps-tot-a{font-family:"IBM Plex Mono",ui-monospace,monospace;font-weight:500;
            font-size:10px;letter-spacing:-.01em;margin-top:.5mm;
            font-variant-numeric:tabular-nums;}
  .ps-tot-d{font-size:5.5px;color:var(--ps-ink3);margin-top:.3mm;line-height:1.3;}
