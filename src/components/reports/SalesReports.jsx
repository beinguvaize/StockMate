...
const SalesReports = ({ sales, clients, products, businessProfile}) => {
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
        ...
        <div className="p-5 bg-white border border-border/60 rounded-[1.5rem] shadow-sm relative overflow-hidden group hover:border-black/10 transition-all flex flex-col justify-center">
          ...
          <div className="relative z-10 flex flex-col">
            <span className="text-[10px] uppercase font-bold text-muted-foreground mb-1 block tracking-widest">Total Net Sales</span>
        ...
        <div className="p-5 bg-white border border-border/60 rounded-[1.5rem] shadow-sm relative overflow-hidden group hover:border-black/10 transition-all flex flex-col justify-center">
          ...
          <div className="relative z-10 flex flex-col">
            <span className="text-[10px] uppercase font-bold text-muted-foreground mb-1 block tracking-widest">Active Accounts</span>
            <div className="text-3xl font-semibold text-foreground tabular-nums tracking-tight leading-none mt-0.5">
              {ribbonMetrics.activeAccounts} <span className="text-sm font-bold opacity-30 text-foreground tracking-wider ml-1">Entities</span>
            </div>
        ...
        <div className="p-5 bg-white border border-border/60 rounded-[1.5rem] shadow-sm relative overflow-hidden group hover:border-black/10 transition-all flex flex-col justify-center">
          ...
          <div className="relative z-10 flex flex-col">
            <span className="text-[10px] uppercase font-bold text-muted-foreground mb-1 block tracking-widest">Top Debtor Exposure</span>
            ...
            <div className="mt-3">
              <span className="text-[11px] font-bold text-foreground truncate block max-w-full">
        ...
        <div className="p-5 bg-white border border-border/60 rounded-[1.5rem] shadow-sm relative overflow-hidden group hover:border-black/10 transition-all flex flex-col justify-center">
          ...
          <div className="relative z-10 flex flex-col">
            <span className="text-[10px] uppercase font-bold text-muted-foreground mb-1 block tracking-widest">Avg Ticket Size</span>
            <div className="text-3xl font-semibold text-foreground tabular-nums tracking-tight leading-none mt-0.5">
              <span className="text-[16px] text-foreground/30 mr-1">{businessProfile.currencySymbol}</span>
 ...
 <div key={customer.id} className="p-6 bg-canvas/40 rounded-[1.5rem] border border-border/60 hover:bg-white hover:shadow-xl transition-all group relative overflow-hidden">
