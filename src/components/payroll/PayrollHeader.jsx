...
const PayrollHeader = ({ 
 ...
 <div>
 <h1 className="text-4xl md:text-7xl font-black font-sora text-ink-primary leading-[0.85] tracking-tight mb-2 uppercase">PAYROLL<span className="text-accent-signature">.</span></h1>
 <p className="text-[10px] font-semibold text-gray-600 opacity-80 mb-6 uppercase">COMPENSATION & STAFF ACCOUNTS</p>
 </div>
 </div>
 ...
 <div className="text-sm font-semibold text-gray-700 opacity-70">Active Staff</div>
 <div className="text-xl md:text-2xl font-semibold text-ink-primary leading-none">{activeEmployeesCount} Staff</div>
 </div>
 </div>
 ...
 <div className="flex flex-col -space-y-1">
 <div className="text-sm font-semibold text-gray-700 opacity-70">Monthly Cost</div>
 <div className="text-xl md:text-2xl font-semibold text-ink-primary leading-none tabular-nums">
 ...
 <div className="flex flex-col -space-y-1">
 <div className="text-sm font-semibold text-gray-700 opacity-70">Status</div>
 <div className="flex items-baseline gap-2">
 <div className={`text-xl md:text-2xl font-semibold leading-none ${lastPayRun ? 'text-ink-primary' : 'text-red-500'}`}>
 {lastPayRun ? 'SYNCED' : 'PENDING'}
 </div>
 {lastPayRun && (
 <span className="text-[10px] font-semibold text-gray-700 opacity-70 hidden md:inline">
 ...
 <button className="px-4 md:px-6 py-2 rounded-pill border border-black/10 font-bold text-ink-primary hover:bg-black/5 transition-all text-[10px] cursor-pointer h-10 flex items-center justify-center gap-2" onClick={handleMonthlyReset}>
 <Calendar size={14} className="opacity-70" /> Reset Monthly
 </button>
 )}
 {!viewOnly && (
 <button className="px-4 md:px-6 py-2 rounded-pill border border-black/10 font-bold text-ink-primary hover:bg-black/5 transition-all text-[10px] cursor-pointer h-10 flex items-center justify-center gap-2" onClick={openPayRun} disabled={activeEmployeesCount === 0}>
