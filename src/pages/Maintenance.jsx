...
const Maintenance = () => {
 ...
 <div className="max-w-md w-full glass-panel !p-6 !rounded-[40px] border border-black/5 shadow-premium text-center relative z-10 animate-fade-in">
 {/* Icon Container */}
 ...
 {/* Text Content */}
 <h1 className="text-4xl font-semibold text-ink-primary leading-none mb-4">
 ...
 <span className="text-xs font-semibold">RETURN TO LOGIN</span>
 </button>
 </div>
 ...
 <span className="text-[9px] font-semibold text-[#747576]">LEDGR™ ENTERPRISE CLOUD</span>
 </div>
 </div>
 </div>
 </div>
