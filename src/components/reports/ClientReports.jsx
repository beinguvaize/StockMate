...
const ClientReports = ({ clients, sales, businessProfile}) => {
 ...
 <div className="w-8 h-8 bg-ink-primary text-primary-foreground rounded-full flex items-center justify-center text-sm font-semibold">
 {i + 1}
 </div>
 <div>
 <div className="text-[11px] font-semibold text-foreground truncate max-w-[150px]">{c.name}</div>
 ...
 className="bg-transparent border-none outline-none w-full text-[10px] font-semibold text-foreground placeholder:opacity-60"
 value={searchTerm}
 ...
 <h4 className="text-sm font-semibold text-foreground mb-1">{c.name}</h4>
