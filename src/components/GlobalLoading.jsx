...
"READYING ENTERPRISE WORKSPACE"
 ...
 <div className="w-16 h-16 bg-white rounded-lg shadow-[0_20px_50px_rgba(0,0,0,0.08)] border border-black/5 flex items-center justify-center rotate-45 transform transition-transform group-hover:rotate-90 duration-1000">
 ...
 <p className="text-[10px] font-semibold text-black/30 animate-in fade-in slide-in-from-bottom-2 duration-700 whitespace-nowrap" key={statusIndex}>
 ...
 <span className="text-[8px] font-semibold text-black/60">System Ready & Synchronized</span>
 </div>
 </div>
