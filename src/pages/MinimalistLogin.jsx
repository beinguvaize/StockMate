    ...
    <div className="min-h-screen bg-canvas text-ink-primary font-sans flex flex-col items-center justify-center p-6">
      <div className="w-full max-w-[420px]">
        <div className="mb-10 text-center">
          ...
          <p className="text-[13px] font-medium text-muted-foreground mt-1.5">GST billing, inventory &amp; reports for Indian business.</p>
        </div>
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            <div className="space-y-1.5">
              ...
              <div className="relative group">
                <Mail size={17} strokeWidth={2.4} className="absolute left-4 top-1/2 -translate-y-1/2 text-muted-foreground group-focus-within:text-accent-signature transition-colors" />
                <input type="email" value={email} onChange={(e) => setEmail(e.target.value)} placeholder="name@company.com" required
                  className="w-full pl-11 pr-4 h-11 rounded-xl bg-muted border border-transparent focus:bg-white focus:border-accent-signature/40 focus:ring-2 focus:ring-accent-signature/20 focus:outline-none transition-all placeholder:text-muted-foreground font-medium text-[14px]" />
              </div>
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative group">
                <Lock size={17} strokeWidth={2.4} className="absolute left-4 top-1/2 -translate-y-1/2 text-muted-foreground group-focus-within:text-accent-signature transition-colors" />
